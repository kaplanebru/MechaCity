...
public static class Eventbus
{
    ...
    public static class CombatEvents
    {
        ...
        public static Action<int> OnCombatCompleteRequest;
    ...
    public static class LinkEvents
    {
        ...
        public static Action<List<int>> OnLinkMotionEnabled;
    ...
    {
        public static Action<uint, int, int> OnShoot;
    ...
    public static class TowerEvents
    {
        ...
        public static Action<int> OnBridgeDestroyRequest;
