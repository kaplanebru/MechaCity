...
public class ChainEditorWindow : EditorWindow
{
    ...
    void CreateChainData()
    {
        ...
        AssetDatabase.CreateAsset(chainData, MyEditorHelpers.WriteAssetPath(nameof(ChainData) + MyEditorHelpers.GetTypeIndex(nameof(ChainData)), "ChainDatas")); //(chainData, "Assets/chainData.asset"); //TODO ismine +1 eklenir foldera bakılıp
